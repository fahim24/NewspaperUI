	...
	return (
		<section>
			...
			<div className="grid grid-cols-1 lg:grid-cols-2 gap-8 my-6">
				<div className="flex flex-col w-full p-5 items-start gap-4 border border-solid border-ClGray">
					<div className="flex items-center gap-5 ">
						<img src={P1} alt="" className="w-24 h-24 rounded-full shrink-0 object-cover" />
